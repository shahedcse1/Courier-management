...
!function (a) {
    ...
    var m = {
        ...
        return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = e, this.initialize = function () {
            ...
            var a = d.head(arguments), e = d.tail(d.from(arguments)),
            ...
            var a = d.head(arguments), b = d.tail(d.from(arguments)), c = a.split("."), e = c.length > 1,
                f = e && d.head(c), g = e ? d.last(c) : d.head(c), h = this.modules[f || "editor"];
    ...
    var r = function (b, c, d, e) {
        ...
        u = s.create('<div class="note-toolbar panel-heading"/>'), v = s.create('<div class="note-editing-area"/>'),
        ...
        z = s.create('<div class="note-editor"/>'), A = s.create('<div class="note-editable" contentEditable="true"/>'),
    ...
    var K, L = function () {
        ...
        var b = function (a, b) {
            ...
            this.getPoints = function () {
                ...
                a = a || c.ok;
                var e = b && b.includeAncestor, f = b && b.fullyContains, g = this.getStartPoint(),
                    h = this.getEndPoint(), i = [], j = [];
            ...
            this.isOnEditable = k(p.isEditable), this.isOnList = k(p.isList), this.isOnAnchor = k(p.isAnchor), this.isOnCell = k(p.isCell), this.isLeftEdgeOf = function (a) {
                ...
                var c = a("<div></div>").html(b)[0], e = d.from(c.childNodes),
        ...
        return {
            create: function (a, b, c, d) {
                ...
                var c = p.fromOffsetPath(a, b.s.path), d = b.s.offset, e = p.fromOffsetPath(a, b.e.path),
                    g = b.e.offset;
                return new f(c, d, e, g)
            }, createFromParaBookmark: function (a, b) {
                var c = a.s.offset, e = a.e.offset, g = p.fromOffsetPath(d.head(b), a.s.path),
        ...
        this.fromNode = function (a) {
            ...
            b = b.splitText();
            var f = e && e.nodeName || "SPAN", g = !(!e || !e.expandClosestSibling),
        ...
        this.insertOrderedList = function (a) {
            ...
            var e = this, f = M.create(b).wrapBodyInlineWithPara(), g = f.nodes(p.isPara, {includeAncestor: !0}),
            ...
            var g = M.create(f).wrapBodyInlineWithPara(), h = g.nodes(p.isPara, {includeAncestor: !0}),
                i = g.paraBookmark(h), j = d.clusterBy(h, c.peq2("parentNode"));
            ...
            var c = d.head(a), e = d.last(a), f = p.isList(c.previousSibling) && c.previousSibling,
                g = p.isList(e.nextSibling) && e.nextSibling, h = f || p.insertAfter(p.create(b || "UL"), e);
            ...
            return a.each(b, function (b, f) {
                var g = d.head(f), h = d.last(f), i = c ? p.lastAncestor(g, p.isList) : g.parentNode,
        ...
        this.tab = function (a, b) {
            var c = p.ancestor(a.commonAncestor(), p.isCell), e = p.ancestor(c, p.isTable),
                f = p.listDescendant(e, p.isCell), g = d[b ? "prev" : "next"](f, c);
        ...
        var c = this, e = b.layoutInfo.note, f = b.layoutInfo.editor, g = b.layoutInfo.editable, h = b.options,
            i = h.langInfo, j = g[0], k = null, l = new P, n = new S, o = new R, q = new Q, r = new O(g);
        ...
        this.fontSize = function (b) {
            ...
            var m = M.createFromNodeBefore(d.head(j)), n = m.getStartPoint(), o = M.createFromNodeAfter(d.last(j)),
                p = o.getEndPoint();
        ...
        var c = a(document), d = b.layoutInfo.editor, e = b.layoutInfo.editable, f = b.options, g = f.langInfo,
    ...
    var X = function (a) {
        ...
        var c = b.layoutInfo.editor, d = b.layoutInfo.toolbar, e = b.layoutInfo.editable, f = b.layoutInfo.codable,
            g = a(window), h = a("html, body");
        this.toggle = function () {
            var a = function (a) {
        ...
        var e = this, f = a.summernote.ui, g = b.layoutInfo.toolbar, h = b.options, i = h.langInfo,
            j = c.invertObject(h.keyMap[m.isMac ? "mac" : "pc"]), k = this.representShortcut = function (a) {
                var b = j[a];
        ...
        this.initialize = function () {
            ...
            var c, d = 18, e = a(b.target.parentNode), f = e.next(), g = e.find(".note-dimension-picker-mousecatcher"),
                i = e.find(".note-dimension-picker-highlighted"), j = e.find(".note-dimension-picker-unhighlighted");
            if (void 0 === b.offsetX) {
        ...
        this.initialize = function () {
            ...
            var c,
                ...
                e = b.match(d), f = /\/\/instagram.com\/p\/(.[a-zA-Z0-9_-]*)/, g = b.match(f),
                h = /\/\/vine.co\/v\/(.[a-zA-Z0-9]*)/, i = b.match(h),
                j = /\/\/(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11})[?]?.*/, k = b.match(j),
                l = /.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/, m = b.match(l),
                n = /\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/, o = b.match(n), p = /^.+.(mp4|m4v)$/, q = b.match(p),
                r = /^.+.(ogg|ogv)$/, s = b.match(r), t = /^.+.(webm)$/, u = b.match(t);
            if (e && 11 === e[1].length) {
                var v = e[1];
        ...
        var e = this, f = a.summernote.ui, g = 5, h = b.options.hint || [], i = b.options.hintDirection || "bottom",
            j = a.isArray(h) ? h : [h];
        this.events = {
            "summernote.keyup": function (a, b) {
